...
for rate in rate_list:
    ...
    #     rate = 2.0
        res_path = 'test_C_GD_Offload_lane2_rate_'+str(rate)+'/'
        init_path = ''
        ...
        for i in range(MAX_EPISODE):
            ...
            np.savez(step_result, step_reward, step_power, step_buffer, step_power_local, step_power_offload,step_power_vehicle)
