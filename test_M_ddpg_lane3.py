...
for rate in rate_list:
    ...
    for k in range(1,10):
        ...
        res_path = 'test_C_ddpg_sigma0_02_rate' + str(rate) + '_lane2/'
        step_result_path = res_path + 'step_result/'
        model_fold = 'model_C_ddpg_sigma0_02_rate3_lane2/'
        model_path = 'model_C_ddpg_sigma0_02_rate3_lane2/my_train_model_rate_3_' + str(3) + '-2000'
        ...
        for i in range(MAX_EPISODE):
            ...
            np.savez(step_result, step_reward, step_power, step_buffer, step_pl, step_po,step_pv)  #这个才是test返回到图里的值
